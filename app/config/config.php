...
define("HOST","server267.web-hosting.com");
define("USER","axewuhgj"/*"axewuhgj_administrador"*/);
define("PASS","7YPuRYiNUJW7"/*"$sys.@dmin123"*/);
define("NAME","axewuhgj_mvc");
...
//El nombre de el sitio
define("NOMBREAPP","Axl");
